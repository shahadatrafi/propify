...
const PropertyCard = ({ property: { title, location, agent, beds, baths, size, price, image, id } }) => {
      ...
      <div className="flex items-center justify-between mt-6">
        <div>
          <p className="text-3xl font-bold">
            ${price} <span className="text-2xl font-normal text-black">USD</span>
          </p>
        </div>
        <div>
          <Button1 to={`/${id}`} text={"view"}></Button1>
        </div>
      </div>
    </div>
  );
